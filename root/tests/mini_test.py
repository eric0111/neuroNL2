...
def test():
    ...
    path = "/home/eb/PycharmProjects/neuroNL2/root/bin/output/stopsignal2/time_series_dict/sub-10159_task-stopsignal_bold_space-MNI152NLin2009cAsym_preproc.npy"
    import numpy as np
